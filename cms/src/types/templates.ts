...
export interface ProductReference {
  page_slug: string;
  categories: string[]; // filter_key values
  badge: string; // e.g. 'Launching Soon', 'New', ''
  sort_order: number;
  description: string; // hub page one-liner, fallback to page meta_description
}

export interface CategoryFilterContent {
  section_title: string;
  section_icon: string; // emoji or icon identifier
