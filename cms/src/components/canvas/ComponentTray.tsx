...
export const TRAY_COMPONENTS: TrayComponentDef[] = [
  ...
  },
  {
    ...
    defaultSpan: { cols: 40, rows: 8 },
  },  // ── Product Tabs V2 (horizontal top bar — new template) ──
  {
    type: 'ProductTabsV2',
    label: 'Product Tabs (New — Horizontal)',
    description: 'Horizontal top-aligned tab bar: Overview │ Specs │ Docs │ Videos …',
    icon: '\uD83D\uDDC2\uFE0F',
    category: 'interactive',
    defaultMeta: {
      active_color: '#22c55e',
  ...
  {
    type: 'ProductHeroNew',
    label: 'Product Hero (New)',
    description: 'Two-column product hero: SKU badge + image left, highlights + pricing + CTA right',
    icon: '🛒',
    category: 'content',
    defaultMeta: {
      bgColor: '#ffffff',
  ...
  // ── Newsletter Subscribe ──
  {
    ...
    description: '"Subscribe for latest updates" email capture strip with inline input & button',
    icon: '📧',
    category: 'interactive',
    defaultMeta: {
      bgColor: '#f0f4f8',
    ...
    defaultSpan: { cols: 40, rows: 3 },
  },

  // ── Targeted Applications ──
  {
    type: 'TargetedApplications',
    label: 'Targeted Applications (Slider)',
    description: 'Image + title application cards in a horizontal slider with nav arrows',
  ...
  {
    type: 'FAQNew',
    label: 'FAQ Accordion (New)',
    description: 'Clean card-style FAQ accordion with +/× toggle, rich text answers & CTA links',
    icon: '❓',
    category: 'interactive',
    defaultMeta: {
      bgColor: '#f3f4f6',
  ...
  // ── Resource Tab ──
  {
    type: 'ResourceTab',
    label: 'Resource Tab',
    description: 'Left sidebar tabs with right-panel card slider — resources, downloads, media',
    icon: '📂',
    category: 'interactive',
    defaultMeta: {
      bgColor: '#ffffff',
